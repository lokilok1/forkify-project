...
class PaginationView extends View {
    ...
    _generateMarkup() {
        ...
        if (curPage === 1 && numPages > 1) {
            return this._generateNextPageBtn(curPage);
        }

        // Last page
        if (curPage === numPages && numPages > 1) {
            return this._generatePrevPageBtn(curPage);
        }
        // Other page
        if (curPage < numPages) {
            return `${this._generatePrevPageBtn(curPage)}${this._generateNextPageBtn(curPage)}`;
        }
